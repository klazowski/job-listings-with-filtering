...
const App = (): JSX.Element => {
  ...
  const addFilterHandler = (filter: Filter): void => {
    if (!appliedFilters.includes(filter)) setAppliedFilters([...appliedFilters, filter])
  }
      ...
      <main className="main">
        <div className="container">
          {appliedFilters.length > 0 ? (
            <AppliedFilters appliedFilters={appliedFilters} removeFilters={removeFiltersHandler} />
          ) : null}
